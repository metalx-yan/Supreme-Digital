            ...
            <div class="card-body">
                @if (Auth::user()->role->name == 'administrator')
                    ...
                    @elseif(Auth::user()->role->name == 'direktur')
                        <form action="{{ route('direkturmaintenances.update', $get->id) }}" method="post">
                        @else
                            <form action="{{ route('itsupportmaintenances.update', $get->id) }}" method="post">
                @endif
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="date" name="created_at"
                                value="{{ Carbon\Carbon::parse($get->created_at)->format('Y-m-d') }}"
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="no" value="{{ $get->no }}"
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="perihal" value="{{ $get->perihal }}"
